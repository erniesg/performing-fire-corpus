...
from index fields. Safe text is a positive NFC contract for Latin (including
Vietnamese), precomposed Korean, Japanese, and CJK metadata plus a small
reviewed punctuation set. Combining marks, Hangul Jamo, and combining Kana
marks are excluded so decomposed equivalents cannot acquire distinct hashes;
